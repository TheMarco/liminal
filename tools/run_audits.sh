...
AUDITS=(
	...
	"reported_placement|tools/audit_reported_placement.gd|"
	"mall_shopping_carts|tools/audit_mall_shopping_carts.gd|"
	"mall_signs|tools/audit_mall_signs.gd|"
	"mall_payphone|tools/audit_mall_payphone.gd|"
	"mall_directory|tools/audit_mall_directory.gd|"
	"chemistry_props|tools/audit_chemistry_props.gd|"
	"office_school_bins|tools/audit_office_school_bins.gd|"
	"slots|tools/audit_slots.gd|"
	"casino_slots|tools/audit_casino_slots.gd|"
	"slot_presentation|tools/audit_slot_presentation.gd|"
	"casino_wall_surfaces|tools/audit_casino_wall_surfaces.gd|"
	"casino_service_cart|tools/audit_casino_service_cart.gd|"
	...
	"datacenter_charging|tools/audit_datacenter_charging.gd|"
	...
	"charger_locator|tools/audit_charger_locator.gd|"
	...
	"reality_aftershock|tools/audit_reality_aftershock.gd|"
	"reality_approach|tools/audit_reality_approach.gd|"
	...
	"shadow_walker_prototype|tools/audit_shadow_walker_prototype.gd|"
	"walker_stride|tools/measure_walker_stride.gd|"
	"caught_sequence|tools/audit_caught_sequence.gd|--mode=descent --nologo"
	"caught_floor|tools/audit_caught_floor.gd|"
	...
	"photo_slot_model|tools/audit_photo_slot_model.gd|"
	...
	"realm_campaign|tools/audit_realm_campaign.gd|--mode=descent --nologo --seed=21"
	"discovery_spawn_hold|tools/audit_discovery_spawn_hold.gd|"
	"realm_visit_progress|tools/audit_realm_visit_progress.gd|"
	"first_door|tools/audit_first_door.gd|--mode=descent --nologo"
	"first_door_generation|tools/audit_first_door_generation.gd|8"
	"photo_coverage|tools/audit_photo_coverage.gd|--mode=descent --nologo"
	"title_screen|tools/audit_title_screen.gd|"
	"asset_credits|tools/audit_asset_credits.gd|"
	...
	"atomic_persistence|tools/audit_atomic_persistence.gd|"
	"photo_framing|tools/audit_photo_framing.gd|"
	"ambient_palette|tools/audit_ambient_palette.gd|"
	"shared_sounds|tools/audit_shared_sounds.gd|"
	"route_setpieces|tools/audit_route_setpieces.gd|"
	"objective_prompts|tools/audit_objective_prompts.gd|--mode=descent --nologo"
	"procedural_details|tools/audit_procedural_details.gd|"
	...
	"pool_corner_boundaries|tools/audit_pool_corner_boundaries.gd|"
	...
	"pool_jacuzzi_movement|tools/audit_pool_jacuzzi_movement.gd|"
	...
	"charger_audio|tools/audit_charger_audio.gd|--test-mode --nologo"
	"charging_station_placement|tools/audit_charging_station_placement.gd|"
	"vegas_change_machine|tools/audit_vegas_change_machine.gd|"
	"nostalgia_props|tools/audit_nostalgia_props.gd|"
	"machine_wall_placement|tools/audit_machine_wall_placement.gd|"
	"airport_mall_ambience|tools/audit_airport_mall_ambience.gd|"
	...
	"pool_layout|tools/audit_pool_layout.gd|"
	"pool_entries|tools/audit_pool_entries.gd|"
	"pool_equipment|tools/audit_pool_equipment.gd|"
	"pool_equipment_availability|tools/audit_pool_equipment_availability.gd|"
	"pool_equipment_movement|tools/audit_pool_equipment_movement.gd|"
	"pool_slide_lifecycle|tools/audit_pool_slide_lifecycle.gd|"
