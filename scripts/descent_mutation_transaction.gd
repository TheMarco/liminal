...
extends RefCounted
## One explicit blackout-mutation transaction from selection through commit.
##
...
func _init(p_delta: TopologyDelta, p_assistance: bool,
...
func stage(manager: ChunkManager, when_ready: Callable) -> bool:
