...
Rebuild: python3 tools/blender/draw_vintage_vending.py, then Blender --background --python tools/blender/build_vintage_vending.py -- vegas_cigarette_machine.

3,486 triangles; 2 surfaces; 1K baked texture set and advertising atlas. Metres, +Z front, floor Y=0.
