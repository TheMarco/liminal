# Fluorescent Light Fixtures — 4x 4096px²
...
- **Local file:** `fluorescent_light_fixtures.glb`
...
Godot extracted the GLB's sixteen embedded texture images beside the local
model during import. No texture artwork was repainted.
